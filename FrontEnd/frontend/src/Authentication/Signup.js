    ...
    return (
        <div className='container'>
            ...
            <div className='box'>
                ...
                <label>Image</label>
                <input type='text' name="image" placeholder='Enter Image URL' value={image} onChange={handleChange} />
